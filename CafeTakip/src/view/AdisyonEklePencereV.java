 ...
 * @author yetishbey
 */
public class AdisyonEklePencereV extends javax.swing.JFrame {

    /**
     * Creates new form AdisyonEklePencereV
     */
    public AdisyonEklePencereV() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdisyonEklePencereV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdisyonEklePencereV().setVisible(true);
            }
        });
    }
